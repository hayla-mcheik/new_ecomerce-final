            ...
            <div class="swiper-slide">
                <div class="product__media--preview__items">
                    <a class="product__media--preview__items--link glightbox"
                       ...
                       href="{{ asset($product->productImages[0]->image) }}">
                        <img id="mainProductImage" class="product__media--preview__items--img"
        ...
        <div class="swiper-wrapper">
            @foreach($product->productImages as $index => $itemImg)
                <div class="swiper-slide">
                    ...
                    <img class="product__media--nav__items--img thumbnail" src="{{ asset($itemImg->image) }}" alt="product-nav-img" data-index="{{ $index }}">
                    </div>
                </div>
            @endforeach
        </div>
...
@endif
                        ...
                        <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                        <div class="quantity__box">
                                            <button type="button" class="quantity__value quickview__value--quantity decrease"  wire:click="decrementQuantity">-</button>
                                            <label>
                                                <input type="number" class="quantity__number quickview__value--number" value="1" wire:model="quantityCount" value="{{ $this->quantityCount }}" readonly />
                                            </label>
                                            <button type="button" class="quantity__value quickview__value--quantity increase" wire:click="incrementQuantity">+</button>
                                        </div>
                                        <button class="primary__btn quickview__cart--btn" type="submit"  wire:click="addToCart({{ $product->id }})" >Add To Cart</button>  
                                    </div>
                        
                                    <div class="product__variant--list mb-20">
                                        <a class="variant__wishlist--icon mb-15" wire:click="addToWishList({{ $product->id }})">
