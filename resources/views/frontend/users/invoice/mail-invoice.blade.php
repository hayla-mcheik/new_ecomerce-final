...
<div class="text-center">
    ...
    <p>Thank you for purchasing with {{ $appSetting->website_name ?? "Ecomerce from zero" }}.
        <br/>
        ...
        <thead>
            <tr>
                ...
                <th width="50%" colspan="2" class="text-end company-data">
                    ...
                    <span>Address: beirut , lebanon</span> <br>
                </th>
            </tr>
            <tr class="bg-blue">
...
<tr>
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with Ecomerce from Zero
    </p>
