        ...
        <div class="header__topbar bg__primary">
            <div class="container">
                <div class="header__topbar--inner text-center">
                    <p class="header__info--text text-white">FREE SHIPPING FOR ORDERS OVER $100 !</p>
                </div>
            </div>
        </div>
                        ...
                        <ul class="header__account--wrapper d-flex align-items-center">
                            ...
                            <li class="header__account--items header__minicart--items" >
                                <a class="header__account--btn minicart__open--btn" href="{{ url('/cart') }}">
                                    ...
                                    <span class="items__count"><livewire:frontend.cart.cart-count /></span> 
                                </a>
                            </li>
    ...
    <li class="header__menu--items">
                                    <a class="header__menu--link" href="#"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    @endguest
        ...
        <div class="offcanvas__header">
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.html">
                        <img src="assets/img/logo.png" alt="Logo-img" width="108" height="36">
                    </a>
           ...
           @guest
               @if (Route::has('login'))
                   <li class="offcanvas__menu_li">
                    <a href="{{ route('login') }}">
                       <span class="offcanvas__account--items__label">{{ __('Login') }}</span></a>
                   </li>
               @endif
               ...
               @if (Route::has('register'))
                   <li class="offcanvas__menu_li">
                       ...
                       <span class="offcanvas__account--items__label">{{ __('Register') }}</span></a>
                   </li>
               @endif
               @else
               <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="#">{{ Auth::user()->name }} </a>
                            <ul class="offcanvas__sub_menu">
                                <li class="offcanvas__sub_menu_li"><a  class="offcanvas__sub_menu_item">My Cart</a></li>
                                <li class="offcanvas__sub_menu_li">
                                    <a  class="offcanvas__sub_menu_item" href="{{ route('logout') }}"
                                    onclick="event.preventDefault();
        ...
        <div class="offcanvas__sticky--toolbar">
            <ul class="d-flex justify-content-between">
                <li class="offcanvas__sticky--toolbar__list">
                    <a class="offcanvas__sticky--toolbar__btn" href="{{ url('/') }}">
        ...
        <div class="predictive__search--box ">
            <div class="predictive__search--box__inner">
                ...
                <form class="predictive__search--form" action="{{ url('search') }}" method="GET" role="search">
                    <label>
                        <input class="predictive__search--input" placeholder="Search Here" type="search" value="{{ Request::get('search') }}"  name="search">
                    </label>
