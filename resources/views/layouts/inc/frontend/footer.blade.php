                            ...
                            <div class="footer__widget--inner">
                                <div class="footer__logo">
                                    <a class="footer__logo--link" href="index.html">
                                        <img class="footer__logo--img" src="assets/img/logo.png" alt="logo-img" width="200">
                                    </a>
                                </div>
                                ...
                                <ul class="footer__widget--info">
                                    <li class="footer__widget--info_list">
                                        ...
                                        <span class="footer__widget--info__text">Beirut,lebanon</span>
                                    </li>
                                    <li class="footer__widget--info_list">
                                        ...
                                        <a class="footer__widget--info__text" href="tel:+1234567898">:+96171922944</a>
                                    </li>
                                    <li class="footer__widget--info_list">                                     
                                        ...
                                        <a class="footer__widget--info__text" href="mailto:example@example.com">hussein.a.mk@houselashhes.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="footer__bottom">
            <div class="container">
                <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                    <p class="copyright__content mb-0"><span class="text__secondary">© 2023</span> Powered by <a class="copyright__content--link" target="_blank" href="https://themeforest.net/search/hooktheme">WebGenius_hayla</a> .  All Rights Reserved.</p>
        ...
        <div id="boxes" class="newsletter__popup--inner">
            ...
            <div class="box newsletter__popup--box d-flex align-items-center">
                <div class="newsletter__popup--thumbnail">
                    <img class="newsletter__popup--thumbnail__img display-block" src="assets/img/img1.jpg" alt="newsletter-popup-thumb">
                </div>
